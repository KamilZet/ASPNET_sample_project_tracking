<%@ Page Language="vb" MasterPageFile="Project.master" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Project_Default" Title="Project"  %>
...
<div class="space">
<a href="javascript:create('<%#Date.Today.ToString("s")%>')" class="button">New task</a>
</div>
